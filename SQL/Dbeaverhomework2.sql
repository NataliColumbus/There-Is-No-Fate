--.файл в котором под каждой командой напишите  запрос который выполнит команду.
--файл выгружайте на гит и скидывайте ссылки на проверку.
...
-- 
   select name  from students  where  = '12333' or password = '1m313'or password ='123313';
